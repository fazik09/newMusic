		   ...
		   <!-- Collect the nav links, forms, and other content for toggling -->
		    ...
		    <div class="navbar-default sidebar" role="navigation">
				...
				<li>
                    ...
                    <li>
                        <a href="#" class=" hvr-bounce-to-right"><i class="fa fa-indent nav_icon"></i> <span class="nav-label">Executors</span><span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li><a href="listArtists.php" class=" hvr-bounce-to-right"> <i class="fa fa-area-chart nav_icon"></i>-> List</a></li>
                            
							<li><a href="addartists.php" class=" hvr-bounce-to-right"> <i class="fa fa-area-chart nav_icon"></i>-> New Executor</a></li>
					   </ul>
                    </li>
					 <!-- <li>
                    ...
                    <li>
                        <a href="#" class=" hvr-bounce-to-right"><i class="fa fa-indent nav_icon"></i> <span class="nav-label">Musics</span><span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li><a href="listMusics.php" class=" hvr-bounce-to-right"> <i class="fa fa-area-chart nav_icon"></i>-> List</a></li>
                            
							<li><a href="addmusics.php" class=" hvr-bounce-to-right"> <i class="fa fa-area-chart nav_icon"></i>-> New Music</a></li>
					   </ul>
                    </li>
					<li>
                        <a href="#" class=" hvr-bounce-to-right"><i class="fa fa-indent nav_icon"></i> <span class="nav-label">Аlbums</span><span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li><a href="listAlboms.php" class=" hvr-bounce-to-right"> <i class="fa fa-area-chart nav_icon"></i>-> List</a></li>
                            
							<li><a href="addalbom.php" class=" hvr-bounce-to-right"> <i class="fa fa-area-chart nav_icon"></i>-> New Album</a></li>
					   </ul>
                    </li>
                    <!-- <li>
